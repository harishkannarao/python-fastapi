...
SAMPLE_TRANSACTION_PROPAGATED_ENDPOINT = "/context/samples/sql/transaction/propagated"
SAMPLE_TRANSACTION_ISOLATED_ENDPOINT = "/context/samples/sql/transaction/isolated"
